	...
	<div id="page" class="hfeed site">
		<header id="masthead" class="site-header" role="banner">
			<div class="container">
				...
				<nav id="navbar" class="site-navigation navbar navbar-expand-lg navbar-light">
					...
					<button style="float: right;margin: 10px;" class="navbar-toggler custom-toggler" type="button"
					...
					<div class="collapse navbar-collapse links" id="navbarSupportedContent">
						<ul class="navbar-nav navbar-menu site-navigate ml-auto">
							...
							<li class="nav-item dropdown">
								<a class="dropdown-toggle nav-link" href="archive.html" id="navbarDropdown"
									role="button" data-toggle="" aria-haspopup="true" aria-expanded="false">Knowledge
									Base</a>
							...
							<li class="nav-item navbar-login d-md-none d-sm-none d-none d-lg-block">
								<a href="#" class="nav-link collapsed" data-toggle="collapse"
									data-target="#login-form">Login <i
										class="sub-indicator fa fa-chevron-circle-down fa-fw text-muted"></i>
								</a>
							</li>
						</ul><!-- .navbar-menu -->
					</div>
					...
					<ul class="nav navbar-nav navbar-login d-lg-none">
						<li class="nav-item"><a href="#" class="collapsed" data-toggle="collapse"
								data-target="#login-form">Login <i
					...
					<div id="login-form" class="login-form collapse fade clearfix">
						<form action="" method="">
							<div class="form-group">
								<input type="text" class="form-control" id="username" title="Username"
		...
		<div class="container" style="background-color:white;margin-top: -68px;border-radius: 5px;margin-left: 100px;">
				...
				<div id="wbox" class="widgetrow text-center">
					<span>
						<a href="register.html" class="register"
							style="background-image: url(&quot;https://cdn.faveohelpdesk.com/themes/default/client/images/register.png&quot;); color: rgb(0, 154, 186);">
							<span class="widgetitemtitle">Register</span>
						</a>
					</span>

					<span>
						<a href="faq.html" class="submitticket"
							style="background-image: url(&quot;https://cdn.faveohelpdesk.com/themes/default/client/images/submitticket.png&quot;); color: rgb(0, 154, 186);">
							<span class="widgetitemtitle">Submit a ticket</span>
						</a>
					</span>
					<span>
						<a href="login.html" class="myticketticket"
							style="background-image: url(&quot;https://cdn.faveohelpdesk.com/themes/default/client/images/news.png&quot;); color: rgb(0, 154, 186);">
							<span class="widgetitemtitle">My tickets</span></a>
					</span>
					<span>
						<a href="archive.html" class="knowledgebase"
							style="background-image: url(&quot;https://cdn.faveohelpdesk.com/themes/default/client/images/knowledgebase.png&quot;); color: rgb(0, 154, 186);">
			...
			<div class="col-sm-6 col-sm-offset-3"
				style="background-color:#f5f2f2;border-radius:5px;border: 1px solid #cebdbd;margin-bottom:85px;margin-left: 273px;">
				<h2 class="box-header with-border" style="padding-left:50px;">Log in to start your session</h2>

				<form action="/action_page.php">
					<div class="form-group">
						<!-- <label for="Name">First Name</label> -->
						<input type="username" class="form-control Email" id="email" placeholder="email/username"
							name="email" required>
					</div>
					<div class="form-group">
						<!-- <label for="Name">Last Name</label> -->
						<input type="password" class="form-control Email" id="pwd" placeholder="password" name="pwd"
							required>
					</div>
					...
					<button type="login" class="btn btn-custom btn-block btn-flat">Log in</button><br>
					<label for="name" style="font-weight:500;padding-top:-10px;"><a href="forgotpassword.html">forgot
							password?</a></label>
					<button type="login" class="btn btn-custom btn-block btn-flat">Login via LDAP</button><br>

					<button type="account create" class="btn btn-custom btn-block btn-flat">Create an Account</button>

					<button type="facebook" class="btn btn-block btn-social btn-flat btn-facebook"
						style="margin-bottom:30px;">log in with facebook</button>
				</form>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row bord">
				<div class="site-info col-md-6">
					<p class="text-muted">Copyright &copy; 2019 <a href="#">ladybirdweb solution</a>. All Rights
						Reserved.</p>
				</div><!-- .site-info -->

				<div class="site-social text-right col-md-6">
					<ul class="list-inline hidden-print">
						<li class="list-inline-item"><a href="#" class="btn btn-social btn-facebook"><i
									class="fab fa-facebook-f fa-fw"></i></a></li>
						<li class="list-inline-item"><a href="#" class="btn btn-social btn-twitter"><i
									class="fab fa-twitter fa-fw"></i></a></li>
						<li class="list-inline-item"><a href="#" class="btn btn-social btn-google-plus"><i
									class="fab fa-google-plus-g fa-fw"></i></a></li>
						<li class="list-inline-item"><a href="#" class="btn btn-social btn-linkedin"><i
									class="fab fa-linkedin-in fa-fw"></i></a></li>

						<li class="list-inline-item"><a href="#" class="btn btn-social btn-youtube"><i
