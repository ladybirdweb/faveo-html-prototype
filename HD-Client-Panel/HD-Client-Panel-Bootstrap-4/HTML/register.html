...
<head>
	...
	<link rel="shortcut icon" href="assets/img/logofaveotilte.png">
...
<body>
	...
	<div id="page" class="hfeed site">
		...
		<div class="site-hero clearfix">
			...
			<div class="container"style="background-color:white;margin-top: -38px;border-radius: 5px;margin-left: 100px;">
<!-- 	
				<div class="content-area">
					<div class="row"> --><div class="col-sm-10">
			<h2 class="box-header with-border" style="padding-top: 20px;"><strong>Register</strong></h2>
			<!-- <div>
				<label for="name">
                    Attachment:</label>
		...
		<form action="/action_page.php">
			<div class="form-group">
              <label for="Name"style="padding-top: 15px;"><strong>First Name</strong></label>
              <label style="color: rgb(233, 27, 47);">*</label>
			  <input type="Name" class="form-control Email" id="email" placeholder="First Name" name="email" required>
			</div>
			<div class="form-group">
              <label for="Name"><strong>Last Name</strong></label>
              <label style="color: rgb(153, 22, 35);">*</label>
			  <input type="Name" class="form-control Email" id="pwd" placeholder="Last Name" name="pwd" required>
            </div>
            <div class="form-group">
