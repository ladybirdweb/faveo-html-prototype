                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                    ...
                                    <li class="dropdown-submenu active">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="active"><a class="dropdown-item" tabindex="-1" href="detail.html">Visitor</a></li>
		...
		<div class="site-hero clearfix">
			<div class="container">
				<ol class="breadcrumb breadcrumb-custom">
					...
					<li class="active"><i class="fas fa-chevron-right"></i>How To Download Our iPad App</li>
				</ol>
			</div>
		</div><!-- .site-hero -->
								...
								<div class="entry-content clearfix">
									<div class="video-frame">
										<object width="560" height="315">
                                            ...
                                            <embed src="https://www.youtube.com/embed/rg_zwK_sSEY" type="application/x-shockwave-flash" width="560" height="315" allowscriptaccess="always" allowfullscreen="true">
                                        </object>
									</div>
