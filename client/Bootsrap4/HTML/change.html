...
<body>
    ...
    <div class="container" style="background-color:white;padding-top:10px;margin-top: -38px;border-radius: 8px;">
        ...
        <div  class="nav-tabs-custom">
            ...
            <a  id="profile_tab" data-toggle="tab" aria-expanded="true" href="profile.html">
                <strong>Edit profile</strong></a></li>
            <li  class="active"style="margin-top:20px;">
                    <li  class="nav-link active">
                <a  id="profile_tab" data-toggle="tab" aria-expanded="false"><strong>Change password</strong></a></li>
             ...
             <div   id="content" class="site-content col-md-12">
              -->
                    ...
                    <!-- </div>
                        ...
                        <label for="First Name"><strong>old password</strong></label> 
                        <label style="color: rgb(220, 53, 69);">*</label>
                        <!----> <div>
                        <input placeholder="" id="password" type="text" class="form-control" style="border-color: rgb(210, 214, 222);"> 
                        <!----></div>
                        </div>
                        <div  id="Last Name" class="col-sm-4 form-group">
                        <label for="Last Name"><strong>New password</strong></label>
                        <label style="color: rgb(220, 53, 69);">*</label>
                         <div>
                        <input  id="text-field" type="text" class="form-control" style="border-color: rgb(210, 214, 222);"> 
                        <!---->
                    </div>
                        </div>
                    ...
                    <div  class="col-sm-12">
                            <div  class="row">
                                    ...
                                    <hr> <button class="btn btn-custom pull-right" style="border-color: rgb(0, 192, 239); background-color: rgb(0, 154, 186);">
                                        <i  class="fas fa-sync-alt"></i> Update
                            </button>
                        </div></div>
        <div class="__cov-progress" style="background-color: rgb(0, 154, 186); opacity: 0; position: fixed; top: 0px; left: 0px; width: 0%; height: 2px; transition: opacity 0.6s ease 0s;padding-bottom: 120px;">
