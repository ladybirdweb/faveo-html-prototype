...
<!-- 	
									...
									<div id="wbox" class="widgetrow text-center">
										<span>
											...
											<span>
												...
												<span>
												<a  href="createticket.html" class="myticketticket" style="background-image: url(&quot;https://cdn.faveohelpdesk.com/themes/default/client/images/news.png&quot;); color: rgb(0, 154, 186);">
	...
	<div class="col-sm-6 col-sm-offset-3"style="background-color:#f5f2f2;border-radius:5px;border: 1px solid #cebdbd;margin-bottom:50px;margin-left: 273px;"> 
        <h2 class="box-header with-border" style="padding-left:130px;">Forgot password</h2>
        
    <form action="/action_page.php">
        <div class="form-group">
          <label for="email">Email</label> 
          <input type="username" class="form-control Email" id="email" placeholder="email/username" name="email" required>
        </div>
              ...
              <label for="name"style="font-weight:500;padding-top:-10px;margin-bottom:20px;"><a href="#">i know my password</a></label>
              <button type="login" class="btn btn-default Button"style="float:right;padding: 3px 40px;margin-bottom:50px;">SEND</button>
