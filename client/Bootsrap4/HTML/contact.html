                    ...
                    <div class="collapse navbar-collapse links" id="navbarSupportedContent">
                        <ul class="navbar-nav navbar-menu site-navigate ml-auto">
							...
							<li class="nav-item dropdown active">
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li class="active"><a class="dropdown-item" href="contact.html">Contact</a></li>
		...
		<div class="site-hero clearfix">
			<div class="container">
				<ol class="breadcrumb breadcrumb-custom">
					...
					<li><a href="#">Home</a></li>
					<li class="active"><i class="fas fa-chevron-right"></i>Contact Us</li>
				</ol>
			</div>
		</div><!-- .site-hero -->
						...
						<div id="content" class="site-content col-sm-12">
							...
							<article class="hentry">
								...
								<div class="entry-content clearfix">
									<div class="map-frame"><div id="map-maker" style="height:300px"></div></div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<ul class="fa-ul with-line-border">
												<li><i class="fa-li fa fa-map-marker text-muted"></i> Street 123 St.Suite 45, New Something, Town City 67890</li>
												<li><i class="fa-li fa fa-phone text-muted"></i> 123-456-7890</li>
												<li><i class="fa-li fa fa-print text-muted"></i> 123-456-7890</li>
												<li><i class="fa-li far fa-envelope text-muted"></i> mail@yoursite.com</li>
											</ul>
											<div class="clearfix"></div>
										</div>
										<div class="col-md-6">
											<form action="" method="post" class="contact-form form-border hidden-print">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="contact-message" cols="30" rows="8"></textarea>
												</div>
