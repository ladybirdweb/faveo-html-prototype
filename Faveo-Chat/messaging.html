  ...
  <div class="content-wrapper">
   ...
   <div class="row py-3">
     ...
     <div class="col-auto">
       <div class="row">
         <div class="col-auto">
     <button type="submit" data-target="#modal-create-ticket" data-toggle="modal"  class="btn btn-primary"><i class="fas fa-plus"></i> New Ticket</button>
         </div>
         <div class="col-auto">
          <div class="input-group">
            ...
            <div class="input-group-append">
              <div onclick="showMoreFilter()" data-target="#modal-show-more" data-toggle="modal" class="input-group-text"> <i  class="fas fa-caret-down"></i></div>
        ...
        <form id="createTicket">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col">
                <label>Subject</label>
                <input type="text" name="subject" id="subject" class="form-control" id="exampleInputEmail1"
                  placeholder="Subject">
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              <div class="col">
                <label>Message</label>
                <textarea type="text" name="message" id="message" class="form-control" id="exampleInputEmail1"
          ...
          <div class="form-group">
            <div class="row">
              <div class="col">
                <label>Tags</label>
                <input type="text" name="tag" id="tag" class="form-control" id="exampleInputEmail1"
                  placeholder="Tags">
              </div>
            </div>
          </div>
...
<script>
  ...
  //  console.log(document.getElementById('crt-tic-btn').re)
