        ...
        <div class="row pt-5">
            ...
            <div class="col-auto pr-5">
                <div class=".modal-close-icon">
                   <a  href="./chat1.html" > <i class=" fas fa-window-close"></i></a>
            </div>
            </div>
          </div>
        <div class="row">
                ...
                <div class="card-body pt-0">
                  <div class="form-group ">
                    ...
                    <div id="input-container">
                        ...
                        <input type="text" name="group" id="group" class="form-control" id="exampleInputEmail1" placeholder="Search Direct Messages">
                        <a id="showorhide"> 
...
<script>
var inputBox = document.getElementById('group');
