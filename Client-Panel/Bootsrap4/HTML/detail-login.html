                        ...
                        <ul class="navbar-nav navbar-menu site-navigate ml-auto">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                    ...
                                    <li class="dropdown-submenu active">
                                        ...
                                        <ul class="dropdown-menu">
											...
											<li class="active"><a class="dropdown-item" tabindex="-1" href="detail-login.html">User Login</a></li>
                                        </ul>
                                    </li>
                                </ul>
							</li>
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="news.html">News Archive</a></li>
		...
		<div class="site-hero clearfix">
			<div class="container">
				<ol class="breadcrumb breadcrumb-custom">
					...
					<li class="active"><i class="fas fa-chevron-right"></i>Aliquam Rhoncus Quis Mi Nec Sodales</li>
				</ol>
			</div>
		</div><!-- .site-hero -->
							...
							<article class="hentry">
								<header class="entry-header">
									...
									<div class="entry-meta text-muted">
										<span class="date"><i class="fa fa-list-alt fa-fw"></i> <time datetime="2013-09-19T20:01:58+00:00">September 19, 2013 at 8:01 pm</time></span>
										<span class="category"><i class="far fa-folder-open fa-fw"></i> <a href="#">Mobile Apps</a></span>
									</div><!-- .entry-meta -->
								</header><!-- .entry-header -->
...
<pre>
&lt;div <span class="text-danger">class=</span><span class="text-primary">"form-group"</span>&gt;
  ...
&lt;/div&gt;
</pre>

<p>This stylesheet code for <code>.form-group</code>:</p>
<pre>
.<span class="text-danger">form-group</span> {
  <span class="text-primary">margin-bottom</span>: 10px;
}
</pre>
										...
										<div class="row">
											<div class="rate-post col-sm-6">
												<ul class="list-inline float-left">
													<li class="list-inline-item"><a href="#" class="btn btn-social btn-like disabled" title="This article was helpful" data-toggle="tooltip"><i class="far fa-thumbs-up fa-fw"></i></a></li>
													<li class="list-inline-item"><a href="#" class="btn btn-social btn-dislike disabled" title="This article was not helpful" data-toggle="tooltip"><i class="far fa-thumbs-down fa-fw"></i></a></li>
												</ul>
											...
											<div class="share-links text-right col-sm-6">
												...
												<ul class="list-inline float-right">
													...
													<li class="list-inline-item"><a href="#" class="btn btn-social btn-pinterest"><i class="fab fa-pinterest fa-fw"></i></a></li>
												</ul>
											</div><!-- .share-links -->
										</div>
									</div><!-- .entry-attribute -->
										...
										<article class="comment-body">
											<footer class="comment-meta">
												<div class="comment-author">
													<img src="assets/img/avatar.png" alt="" height="50" width="50" class="avatar" />
													<b class="fn"><a href="#" rel="external" class="url">John Pantau</a></b>
												</div><!-- .comment-author -->
									...
									<li class="comment">
										<article class="comment-body">
											<footer class="comment-meta">
												<div class="comment-author">
													<img src="assets/img/avatar.png" alt="" height="50" width="50" class="avatar" />
													<b class="fn"><a href="#" rel="external" class="url">Lipsum</a></b>
												</div><!-- .comment-author -->
										...
										<div class="row">
											<div class="col-md-4">
												<div class="banner-wrapper user-data text-center clearfix">
													<img src="assets/img/avatar.png" alt="" height="50" width="50" class="avatar" />
													<h3 class="banner-title h4"><a href="#">User Name</a></h3>
													<div class="banner-content">
														<p>You are not <strong>User Name</strong>?
															<br /><a href="#" class="btn btn-custom btn-sm">Log out</a></p>
													</div>
												</div>
											</div>
											<div class="col-md-8">
												<div class="form-group">
													...
													<textarea class="form-control" id="comment-comment" cols="30" rows="8"></textarea>
												</div>												
											</div>
										</div>
